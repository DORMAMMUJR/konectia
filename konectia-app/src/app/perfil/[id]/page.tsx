      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-8 space-y-6 sm:space-y-8">
            ...
            {/* Active Services (Gig equivalent) */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {pro.portfolio.map((item, i) => {
                  const fakeService = {
                    ...
                    startingPrice: pro.hourlyRate * (i + 1), // Fake varied pricing
                    rating: pro.rating,
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-surface-container-lowest rounded-xl ambient-shadow overflow-hidden">
                <div className="bg-primary p-6 text-white text-center">
                  ...
                  <h3 className="text-2xl font-bold font-[var(--font-headline)]">
                ...
                <div className="p-6 space-y-6">
                  <div className="space-y-4">
                    ...
                    <button className="w-full bg-tertiary hover:bg-tertiary-container text-white font-bold py-3.5 rounded-xl transition-transform active:scale-95 shadow-md flex justify-center items-center gap-2">
