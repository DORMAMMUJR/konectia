      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {categories.map((cat: Category) => (
            <div
              key={cat.id}
              className="group bg-surface-container-lowest p-6 sm:p-8 rounded-xl hover:shadow-xl transition-all border-b-4 border-transparent hover:border-secondary-container cursor-pointer"
            >
              ...
              <h3 className="text-xl font-bold text-primary mb-2 font-[var(--font-headline)]">
                {cat.name}
              </h3>
